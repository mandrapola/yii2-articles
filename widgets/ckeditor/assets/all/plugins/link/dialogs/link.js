        ...
        return {
            ...
            contents: [{
                id: "info", label: b.info, title: b.info, elements: [{
                    type: "text", id: "linkDisplayText",
                    label: b.displayText, setup: function () {
                        this.enable();
                    ...
                    width: "100%", align: "center", padding: 2, id: "popupFeatures", children: [{
                        ...
                        children: [{
                            ...
                            type: "hbox", children: [{
                                ...
                                label: b.popupMenuBar, setup: h, commit: k
                ...
                id: "advanced", label: b.advanced, title: b.advanced, elements: [{
                    ...
                    type: "vbox", padding: 1, children: [{
                        type: "hbox", widths: ["45%", "55%"], children: [{
                            ...
                            requiredContent: "a[title]", "default": "", id: "advTitle", setup: f, commit: l
                        }, {
                            type: "text",
                        ...
                        type: "hbox", widths: ["45%", "55%"], children: [{
                            type: "text",
                            label: b.rel, requiredContent: "a[rel]", "default": "", id: "advRel", setup: f, commit: l
                        }, {
                            type: "text",
                            label: b.styles,
                            requiredContent: "a{cke-xyz}",
            ...
            onOk: function () {
                ...
                var b = e.getSelection(), c = m.getLinkAttributes(e,
                    a);
                if (this._.selectedElement) {
                    var d = this._.selectedElement, g = d.data("cke-saved-href"), h = d.getHtml(), f;
                    d.setAttributes(c.set);
                    d.removeAttributes(c.removed);
                    if (a.linkText && p != a.linkText)f = a.linkText; else if (g == h || "email" == a.type && -1 != h.indexOf("@"))f = "email" == a.type ? a.email.address : c.set["data-cke-saved-href"];
