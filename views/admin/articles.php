    ...
    'columns' => [
        ...
        [
            ...
            'value' => function($model){
             ...
             'filter'=>\yii\helpers\ArrayHelper::map(\mandrapola\article\models\Tree::find()->andWhere(['>','lvl',0])->all(),'id','name',function($model){return $model->parent?$model->parent->name:'';}),
